...
def emailGateway(email_type,recipients,info):#recipent:[student name, tutor name]
    if(email_type=='session_cancel'):
        ...
        print(email_format.format(" Upcoming Session", recipients[1], "You have a session with {} at {}. They can no longer cancel this session. ".format(info.session_student,info.session_datetime)))
