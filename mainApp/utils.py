...
def emailGateway(email_type,recipients,info):#recipent:[student name, tutor name]
    if(email_type=='session_cancel'):
        ...
        print(email_format.format(" Transaction completed.",recipients[0],"The transaction for your Tutoria session (ID={}) has been processed.\n Your payment of {} has been completed.".format(info.id,info.session_tutor.getStudentRate())))
        print(email_format.format(" Transaction completed.",recipients[1],"The transaction for your Tutoria session (ID={}) has been processed.\n {} has been added to your wallet".format(info.id,info.session_tutor.hourly_rate)))
